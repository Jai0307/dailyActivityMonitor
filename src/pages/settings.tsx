...
const Settings: NextPage = (props) => {
    ...
    const getFieldNames = () => {
        ...
        axios.post("/api/getfieldnames", body, config).then((res:any) => {
            ...
            setfield1(res.data.fieldnames.field1Name);
            setfield2(res.data.fieldnames.field2Name);
            setfield3(res.data.fieldnames.field3Name);
            setfield4(res.data.fieldnames.field4Name);
            setfield5(res.data.fieldnames.field5Name);
            setfield6(res.data.fieldnames.field6Name);
            setfield7(res.data.fieldnames.field7Name);
            setfield8(res.data.fieldnames.field8Name);
            setfield9(res.data.fieldnames.field9Name);
            setfield10(res.data.fieldnames.field10Name);
            setfield11(res.data.fieldnames.field11Name);
            setfield12(res.data.fieldnames.field12Name);
            setfield13(res.data.fieldnames.field13Name);
            setfield14(res.data.fieldnames.field14Name);
            setfield15(res.data.fieldnames.field15Name);
            setfield16(res.data.fieldnames.field16Name);
            setfield17(res.data.fieldnames.field17Name);
            setfield18(res.data.fieldnames.field18Name);
            setfield19(res.data.fieldnames.field19Name);
            setfield20(res.data.fieldnames.field20Name);
            setdependent(res.data.fieldnames.dependent);
    ...
    const changefieldnames = (e: any, indx: any) => {
        // fieldNames.
    }
